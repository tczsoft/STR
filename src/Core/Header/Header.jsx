    ...
    return (
        <>
            <div className='fixed top-0 z-50 w-full'>
                <header class="relative flex flex-wrap lg:justify-start lg:flex-nowrap w-full bg-white text-sm py-3 dark:bg-neutral-800">
                    <nav class="max-w-[85rem] w-full mx-auto px-4 lg:flex lg:items-center lg:justify-between">
                        ...
                        <div id="hs-navbar-example" class="hidden hs-collapse overflow-hidden transition-all duration-300 basis-full grow lg:block" aria-labelledby="hs-navbar-example-collapse">
                ...
                <div className='w-full bg-[#2e3051]'>
                    <div className="flex gap-5 items-center justify-center py-2 text-center">
                        <Link to={'/latest'} onClick={toggleMenu} className="pt-3 text-lg text-white block sm:flex hover:text-gray-400 focus:outline-none focus:text-gray-400" aria-current="page"><div><i class="fi fi-rr-time-fast"></i></div> <div className='sm:ms-4'>Latest</div></Link>
                        <Link to={'/trand'} onClick={toggleMenu} className="pt-3 text-lg text-white block sm:flex hover:text-gray-400 focus:outline-none focus:text-gray-400 " href="#"><i class="fi fi-br-arrow-trend-up"></i> <div className='sm:ms-4'>Shop</div></Link>
                        <Link to={'/hot'} onClick={toggleMenu} className="pt-3 text-lg text-white block sm:flex hover:text-gray-400 focus:outline-none focus:text-gray-400 " href="#"><i class="fi fi-rr-fire-flame-curved"></i> <div className='sm:ms-4'>Hot</div> </Link>
                    </div>
                </div>
            </div>
        </>
