export default function Tableheadpanel(props){
    const {newform1,setglobalfilter,setpageChange}=props;
      return(
          <div className="md:flex items-center justify-between px-6 py-4">
              <div className="flex gap-10">
                ...
                <button role="button" onClick={()=>setpageChange(false)} className="text-[16px] font-semibold text-white flex items-center justify-center bg-[#225a2b] px-[10px] py-[6px] rounded-md">
                  Options
                </button>
              </div>
              ...
              <div>
                <div className="md:inline-flex my-3 md:my-0 gap-x-2">
                  ...
                  <button onClick={newform1} className="inline-flex my-3 md:my-0 items-center px-3 py-2 text-sm font-semibold text-white bg-[#225a2b] border border-transparent rounded-lg gap-x-2 disabled:opacity-50 disabled:pointer-events-none">
